...
from prompt_tuning_config import load_project_config, save_test_cases, save_prompts
...
class TestPromptSimulator:
    ...
    def config_with_test_cases(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Create prompts
            prompts = {
                "pr_faq_generation": "Generate PR-FAQ for {projectName}"
            }
